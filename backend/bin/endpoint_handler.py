...
class ConfigApp(admin.MConfigHandler):
    ...
    def setup(self):
        if self.requestedAction == admin.ACTION_EDIT:
            for arg in ["safe_browsing_api_key", "pcap_location", "internal_dns_servers"]:
    ...
    def handleList(self, configuration_information):
        ...
        field_name_list = ["safe_browsing_api_key", "pcap_location", "internal_dns_servers"]
    ...
    def handleEdit(self, _):
        ...
        self.check_field_value("internal_dns_servers")
