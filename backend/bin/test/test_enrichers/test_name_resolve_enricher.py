...
class TestNameResolveEnricherMethods(unittest.TestCase):
    ...
    def test_get_fqdn(self):
        self.name_resolver_enricher.get_fqdn(self.destination_ip_address)
        self.assertEqual(self.name_resolver_enricher.fqdns[self.destination_ip_address], self.destination_fqdn)
    ...
    def test_resolve(self):
        ...
        self.assertEqual(self.name_resolver_enricher.resolve(dst_src), resolved_fqdns)
