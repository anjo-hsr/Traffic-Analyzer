class FileNames:
    ...
    def get_filenames():
        return {
            ...
            "pcap_filenames": ["capture-test_lower.pcap", "capture-test_double_ending.py.pcap",
                               "capture-test_upper.PCAP", "capture-test_camel.Pcap"],

            "pcapng_filenames": ["capture-test_lower.pcapng", "capture-test_double_ending.py.pcapng",
